...
const DaysCounter = () => {
    ...
    return (
      <div className="bg-card rounded-2xl shadow-card p-6 animate-slide-up">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h2 className="text-xl font-heading font-semibold">Dni Razem</h2>
        </div>
  ...
  return (
    <div className="bg-card rounded-2xl shadow-card p-6 animate-slide-up overflow-hidden relative">
