    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 opacity-50 hover:opacity-100 hover:bg-secondary",
        ),
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal aria-selected:opacity-100 hover:bg-secondary/80 rounded-md"
        ),
