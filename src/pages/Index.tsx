...
const defaultLayouts: Layouts = {
  lg: [
    { i: "days-counter", x: 0, y: 0, w: 1, h: 6, minH: 5 },
    { i: "shopping-list", x: 0, y: 6, w: 1, h: 4, minH: 3 },
    { i: "date-ideas", x: 0, y: 10, w: 1, h: 3, minH: 2 },
  ...
  md: [
    ...
    { i: "shared-notes", x: 1, y: 4, w: 1, h: 3, minH: 2 },
    { i: "expense-tracker", x: 1, y: 7, w: 1, h: 5, minH: 4 },
    { i: "mini-calendar", x: 0, y: 13, w: 2, h: 7, minH: 7 },
  ],
  sm: [
    { i: "days-counter", x: 0, y: 0, w: 1, h: 6, minH: 5 },
    { i: "task-list", x: 0, y: 6, w: 1, h: 4, minH: 3 },
    { i: "shopping-list", x: 0, y: 10, w: 1, h: 4, minH: 3 },
    { i: "date-ideas", x: 0, y: 14, w: 1, h: 3, minH: 2 },
    { i: "shared-notes", x: 0, y: 17, w: 1, h: 3, minH: 2 },
    { i: "expense-tracker", x: 0, y: 20, w: 1, h: 5, minH: 4 },
    { i: "mini-calendar", x: 0, y: 25, w: 1, h: 7, minH: 7 },
  ],
};
