...
const defaultLayouts: Layouts = {
  lg: [
    { i: "days-counter", x: 0, y: 0, w: 1, h: 4, minH: 3 },
    { i: "shopping-list", x: 0, y: 4, w: 1, h: 4, minH: 3 },
    { i: "date-ideas", x: 0, y: 8, w: 1, h: 3, minH: 2 },
    { i: "task-list", x: 1, y: 0, w: 1, h: 4, minH: 3 },
    { i: "shared-notes", x: 1, y: 4, w: 1, h: 3, minH: 2 },
    { i: "expense-tracker", x: 1, y: 7, w: 1, h: 5, minH: 4 },
    { i: "mini-calendar", x: 2, y: 0, w: 1, h: 6, minH: 5 },
  ],
  md: [
    { i: "days-counter", x: 0, y: 0, w: 1, h: 4, minH: 3 },
    { i: "shopping-list", x: 0, y: 4, w: 1, h: 4, minH: 3 },
    ...
    { i: "shared-notes", x: 1, y: 4, w: 1, h: 3, minH: 2 },
    { i: "expense-tracker", x: 1, y: 7, w: 1, h: 5, minH: 4 },
    { i: "mini-calendar", x: 0, y: 12, w: 2, h: 5, minH: 5 },
  ],
  sm: [
    { i: "days-counter", x: 0, y: 0, w: 1, h: 4, minH: 3 },
    { i: "task-list", x: 0, y: 4, w: 1, h: 4, minH: 3 },
    { i: "shopping-list", x: 0, y: 8, w: 1, h: 4, minH: 3 },
    { i: "date-ideas", x: 0, y: 12, w: 1, h: 3, minH: 2 },
    { i: "shared-notes", x: 0, y: 15, w: 1, h: 3, minH: 2 },
    { i: "expense-tracker", x: 0, y: 18, w: 1, h: 5, minH: 4 },
    { i: "mini-calendar", x: 0, y: 23, w: 1, h: 5, minH: 5 },
  ],
};
